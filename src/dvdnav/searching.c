...
#define dvdnav_scan_admap(a,b,c,d) ___dvdnav_scan_admap(a,b,c,d)
static dvdnav_status_t ___dvdnav_scan_admap(dvdnav_t *this, int32_t domain, uint32_t seekto_block, uint32_t *vobu) {
...
dvdnav_status_t ___dvdnav_time_search(dvdnav_t *this,
				   uint64_t time) {
...
dvdnav_status_t ___dvdnav_sector_search(dvdnav_t *this,
...
dvdnav_status_t ___dvdnav_part_search(dvdnav_t *this, int32_t part) {
...
dvdnav_status_t ___dvdnav_prev_pg_search(dvdnav_t *this) {
...
dvdnav_status_t ___dvdnav_top_pg_search(dvdnav_t *this) {
...
dvdnav_status_t ___dvdnav_next_pg_search(dvdnav_t *this) {
  vm_t *try_vm;
...
dvdnav_status_t ___dvdnav_menu_call(dvdnav_t *this, DVDMenuID_t menu) {
  vm_t *try_vm;
...
dvdnav_status_t ___dvdnav_get_position(dvdnav_t *this, uint32_t *pos,
				    uint32_t *len) {
  uint32_t cur_sector;
...
dvdnav_status_t ___dvdnav_get_position_in_title(dvdnav_t *this,
					     uint32_t *pos,
					     uint32_t *len) {
  uint32_t cur_sector;
