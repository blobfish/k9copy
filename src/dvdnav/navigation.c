...
dvdnav_status_t ___dvdnav_still_skip(dvdnav_t *this) {
  if(!this) {
...
dvdnav_status_t ___dvdnav_wait_skip(dvdnav_t *this) {
  if(!this) {
    printerr("Passed a NULL pointer.");
    return DVDNAV_STATUS_ERR;
  }
...
dvdnav_status_t ___dvdnav_get_number_of_titles(dvdnav_t *this, int32_t *titles) {
  if(!this || !titles) {
    printerr("Passed a NULL pointer.");
    return DVDNAV_STATUS_ERR;
  }
...
dvdnav_status_t ___dvdnav_get_number_of_parts(dvdnav_t *this, int32_t title, int32_t *parts) {
  if(!this || !parts) {
    printerr("Passed a NULL pointer.");
    return DVDNAV_STATUS_ERR;
  }
...
dvdnav_status_t ___dvdnav_current_title_info(dvdnav_t *this, int32_t *title, int32_t *part) {
  int32_t retval;
...
dvdnav_status_t ___dvdnav_title_play(dvdnav_t *this, int32_t title) {
  if(!this) {
    printerr("Passed a NULL pointer.");
    return DVDNAV_STATUS_ERR;
  }
...
dvdnav_status_t ___dvdnav_part_play(dvdnav_t *this, int32_t title, int32_t part) {
  int32_t retval;
...
dvdnav_status_t ___dvdnav_part_play_auto_stop(dvdnav_t *this, int32_t title,
...
dvdnav_status_t ___dvdnav_time_play(dvdnav_t *this, int32_t title,
				 uint64_t time) {
  if(!this) {
    printerr("Passed a NULL pointer.");
    return DVDNAV_STATUS_ERR;
...
dvdnav_status_t ___dvdnav_stop(dvdnav_t *this) {
  if(!this) {
    printerr("Passed a NULL pointer.");
    return DVDNAV_STATUS_ERR;
  }
...
dvdnav_status_t ___dvdnav_go_up(dvdnav_t *this) {
  if(!this) {
    printerr("Passed a NULL pointer.");
    return DVDNAV_STATUS_ERR;
  }
