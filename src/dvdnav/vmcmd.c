...
#define print_system_reg(a) ___print_system_reg(a)
static void ___print_system_reg(uint16_t reg) {
...
#define print_g_reg(a) ___print_g_reg(a)
static void ___print_g_reg(uint8_t reg) {
    if(reg < 16)
...
#define print_reg(a) ___print_reg(a)
static void ___print_reg(uint8_t reg) {
  if(reg & 0x80)
...
#define print_cmp_op(a) ___print_cmp_op(a)
static void ___print_cmp_op(uint8_t op) {
...
#define print_set_op(a) ___print_set_op(a)
static void ___print_set_op(uint8_t op) {
...
#define print_reg_or_data(a,b,c) ___print_reg_or_data(a,b,c)
static void ___print_reg_or_data(command_t* command, int immediate, int start) {
  if(immediate) {
...
#define print_reg_or_data_2(a,b,c) ___print_reg_or_data_2(a,b,c)
static void ___print_reg_or_data_2(command_t* command, int immediate, int start) {
  if(immediate)
...
#define print_reg_or_data_3(a,b,c) ___print_reg_or_data_3(a,b,c)
static void ___print_reg_or_data_3(command_t* command, int immediate, int start) {
  if(immediate) {
    uint32_t i = vm_getbits(command, start, 16);
...
#define print_if_version_1(a) ___print_if_version_1(a)
static void ___print_if_version_1(command_t* command) {
...
#define print_if_version_2(a) ___print_if_version_2(a)
static void ___print_if_version_2(command_t* command) {
  uint8_t op = vm_getbits(command, 54, 3);
...
#define print_if_version_3(a) ___print_if_version_3(a)
static void ___print_if_version_3(command_t* command) {
  uint8_t op = vm_getbits(command, 54, 3);
...
#define print_if_version_4(a) ___print_if_version_4(a)
static void ___print_if_version_4(command_t* command) {
  uint8_t op = vm_getbits(command, 54, 3);
...
#define print_if_version_5(a) ___print_if_version_5(a)
static void ___print_if_version_5(command_t* command) {
  uint8_t op = vm_getbits(command, 54, 3);
...
#define print_special_instruction(a) ___print_special_instruction(a)
static void ___print_special_instruction(command_t* command) {
...
#define print_linksub_instruction(a) ___print_linksub_instruction(a)
static void ___print_linksub_instruction(command_t* command) {
...
#define print_link_instruction(a,b) ___print_link_instruction(a,b)
static void ___print_link_instruction(command_t* command, int optional) {
  uint8_t op = vm_getbits(command, 51, 4);
...
#define print_jump_instruction(a) ___print_jump_instruction(a)
static void ___print_jump_instruction(command_t* command) {
...
#define print_system_set(a) ___print_system_set(a)
static void ___print_system_set(command_t* command) {
  int i;
...
#define print_set_version_1(a) ___print_set_version_1(a)
static void ___print_set_version_1(command_t* command) {
...
#define print_set_version_2(a) ___print_set_version_2(a)
static void ___print_set_version_2(command_t* command) {
  uint8_t set_op = vm_getbits(command, 59, 4);
...
#define print_set_version_3(a) ___print_set_version_3(a)
static void ___print_set_version_3(command_t* command) {
  uint8_t set_op = vm_getbits(command, 59, 4);
...
void ___vm_print_mnemonic(vm_cmd_t *vm_command)  {
  command_t command;
...
void ___vm_print_cmd(int row, vm_cmd_t *vm_command) {
  int i;
