...
#define dvdnav_clear(a) ___dvdnav_clear(a)
static dvdnav_status_t ___dvdnav_clear(dvdnav_t * this) {
...
dvdnav_status_t ___dvdnav_close(dvdnav_t *this) {
...
dvdnav_status_t ___dvdnav_reset(dvdnav_t *this) {
...
dvdnav_status_t ___dvdnav_path(dvdnav_t *this, const char** path) {
...
const char* ___dvdnav_err_to_string(dvdnav_t *this) {
 ...
 */
#define dvdnav_decode_packet(a,b,c,d) ___dvdnav_decode_packet(a,b,c,d)
static int32_t ___dvdnav_decode_packet(dvdnav_t *this, uint8_t *p, dsi_t *nav_dsi, pci_t *nav_pci) {
  int32_t        bMpeg1 = 0;
  uint32_t       nHeaderLen;
  uint32_t       nPacketLen;
  uint32_t       nStreamID;
 ...
 */ 
#define dvdnav_get_vobu(a,b,c,d) ___dvdnav_get_vobu(a,b,c,d)
static int32_t ___dvdnav_get_vobu(dvdnav_t *this, dsi_t *nav_dsi, pci_t *nav_pci, dvdnav_vobu_t *vobu) {
  uint32_t next;
...
dvdnav_status_t ___dvdnav_get_next_block(dvdnav_t *this, uint8_t *buf,
...
dvdnav_status_t ___dvdnav_get_next_cache_block(dvdnav_t *this, uint8_t **buf,
					    int32_t *event, int32_t *len) {
  dvd_state_t *state;
  int32_t result;
...
dvdnav_status_t ___dvdnav_get_title_string(dvdnav_t *this, const char **title_str) {
...
uint8_t ___dvdnav_get_video_aspect(dvdnav_t *this) {
  uint8_t         retval;
...
uint8_t ___dvdnav_get_video_scale_permission(dvdnav_t *this) {
  uint8_t         retval;
...
uint16_t ___dvdnav_audio_stream_to_lang(dvdnav_t *this, uint8_t stream) {
  audio_attr_t  attr;
...
uint16_t ___dvdnav_spu_stream_to_lang(dvdnav_t *this, uint8_t stream) {
  subp_attr_t  attr;
...
int8_t ___dvdnav_get_audio_logical_stream(dvdnav_t *this, uint8_t audio_num) {
  int8_t       retval;
...
int8_t ___dvdnav_get_spu_logical_stream(dvdnav_t *this, uint8_t subp_num) {
  int8_t       retval;
...
int8_t ___dvdnav_get_active_audio_stream(dvdnav_t *this) {
  int8_t        retval;
...
int8_t ___dvdnav_get_active_spu_stream(dvdnav_t *this) {
  int8_t        retval;
...
#define dvdnav_is_domain(a,b) ___dvdnav_is_domain(a,b)
static int8_t ___dvdnav_is_domain(dvdnav_t *this, domain_t domain) {
  int8_t        retval;
...
dvdnav_status_t ___dvdnav_get_angle_info(dvdnav_t *this, int32_t *current_angle,
...
pci_t* ___dvdnav_get_current_nav_pci(dvdnav_t *this) {
  if(!this) return 0;
  return &this->pci;
}

dsi_t* ___dvdnav_get_current_nav_dsi(dvdnav_t *this) {
  if(!this) return 0;
  return &this->dsi;
}

uint32_t ___dvdnav_get_next_still_flag(dvdnav_t *this) {
  if(!this) return -1;
