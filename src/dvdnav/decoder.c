...
#define get_GPRM(a,b) ___get_GPRM(a,b)
static uint16_t ___get_GPRM(registers_t* registers, uint8_t reg) {
...
#define set_GPRM(a,b,c) ___set_GPRM(a,b,c)
static void ___set_GPRM(registers_t* registers, uint8_t reg, uint16_t value) {
  if (registers->GPRM_mode[reg] & 0x01) {
...
#define eval_reg(a,b) ___eval_reg(a,b)
static uint16_t ___eval_reg(command_t* command, uint8_t reg) {
  if(reg & 0x80) {
    if ((reg & 0x1f) == 20) {
...
#define eval_reg_or_data(a,b,c) ___eval_reg_or_data(a,b,c)
static uint16_t ___eval_reg_or_data(command_t* command, int32_t imm, int32_t start) {
  if(imm) { /*  immediate */
...
#define eval_reg_or_data_2(a,b,c) ___eval_reg_or_data_2(a,b,c)
static uint16_t ___eval_reg_or_data_2(command_t* command,
...
#define eval_compare(a,b,c) ___eval_compare(a,b,c)
static int32_t ___eval_compare(uint8_t operation, uint16_t data1, uint16_t data2) {
  switch(operation) {
    case 1:
      return data1 & data2;
    case 2:
...
#define eval_if_version_1(a) ___eval_if_version_1(a)
static int32_t ___eval_if_version_1(command_t* command) {
...
#define eval_if_version_2(a) ___eval_if_version_2(a)
static int32_t ___eval_if_version_2(command_t* command) {
  uint8_t op = vm_getbits(command, 54, 3);
  if(op) {
...
#define eval_if_version_3(a) ___eval_if_version_3(a)
static int32_t ___eval_if_version_3(command_t* command) {
  uint8_t op = vm_getbits(command, 54, 3);
  if(op) {
...
#define eval_if_version_4(a) ___eval_if_version_4(a)
static int32_t ___eval_if_version_4(command_t* command) {
  uint8_t op = vm_getbits(command, 54, 3);
  if(op) {
...
#define eval_special_instruction(a,b) ___eval_special_instruction(a,b)
static int32_t ___eval_special_instruction(command_t* command, int32_t cond) {
  int32_t line, level;
...
#define eval_link_subins(a,b,c) ___eval_link_subins(a,b,c)
static int32_t ___eval_link_subins(command_t* command, int32_t cond, link_t *return_values) {
...
/* Evaluate link instruction.
   Return 1 if link, or 0 if no link
   Actual link instruction is in return_values parameter */
#define eval_link_instruction(a,b,c) ___eval_link_instruction(a,b,c)
static int32_t ___eval_link_instruction(command_t* command, int32_t cond, link_t *return_values) {
...
#define eval_jump_instruction(a,b,c) ___eval_jump_instruction(a,b,c)
static int32_t ___eval_jump_instruction(command_t* command, int32_t cond, link_t *return_values) {
...
#define eval_system_set(a,b,c) ___eval_system_set(a,b,c)
static int32_t ___eval_system_set(command_t* command, int32_t cond, link_t *return_values) {
  int32_t i;
  uint16_t data, data2;
...
*/
#define eval_set_op(a,b,c,d,e) ___eval_set_op(a,b,c,d,e)
static void ___eval_set_op(command_t* command, int32_t op, int32_t reg, int32_t reg2, int32_t data) {
...
#define eval_set_version_1(a,b) ___eval_set_version_1(a,b)
static void ___eval_set_version_1(command_t* command, int32_t cond) {
...
#define eval_set_version_2(a,b) ___eval_set_version_2(a,b)
static void ___eval_set_version_2(command_t* command, int32_t cond) {
  uint8_t  op   = vm_getbits(command, 59, 4);
...
#define eval_command(a,b,c) ___eval_command(a,b,c)
static int32_t ___eval_command(uint8_t *bytes, registers_t* registers, link_t *return_values) {
  int32_t cond, res = 0;
  command_t command;
