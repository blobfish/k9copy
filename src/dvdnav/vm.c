...
/* Play */
#define play_PGC(a) ___play_PGC(a)
#define play_Cell_post(a) ___play_Cell_post(a)
#define play_PGC_PG(a,b) ___play_PGC_PG(a,b)
#define play_PGC_post(a) ___play_PGC_post(a)
#define play_PG(a) ___play_PG(a)
#define play_Cell(a) ___play_Cell(a)
static link_t ___play_PGC(vm_t *vm);
static link_t ___play_PGC_PG(vm_t *vm, int pgN);
static link_t ___play_PGC_post(vm_t *vm);
static link_t ___play_PG(vm_t *vm);
static link_t ___play_Cell(vm_t *vm);
static link_t ___play_Cell_post(vm_t *vm);

/* Process link - returns 1 if a hop has been performed */
#define process_command(a,b) ___process_command(a,b)
static int ___process_command(vm_t *vm,link_t link_values);

/* Set */
#define set_FP_PGC(a) ___set_FP_PGC(a)
#define set_PGCN(a,b) ___set_PGCN(a,b)
#define set_TT(a,b) ___set_TT(a,b)
#define set_PTT(a,b,c) ___set_PTT(a,b,c)
#define set_VTS_TT(a,b,c) ___set_VTS_TT(a,b,c)
#define set_VTS_PTT(a,b,c,d) ___set_VTS_PTT(a,b,c,d)
#define set_FP_PGC(a) ___set_FP_PGC(a)
#define set_MENU(a,b) ___set_MENU(a,b)
#define set_PGN(a) ___set_PGN(a)
#define set_RSMinfo(a,b,c) ___set_RSMinfo(a,b,c)
static int  ___set_TT(vm_t *vm, int tt);
static int  ___set_PTT(vm_t *vm, int tt, int ptt);
static int  ___set_VTS_TT(vm_t *vm, int vtsN, int vts_ttn);
static int  ___set_VTS_PTT(vm_t *vm, int vtsN, int vts_ttn, int part);
static int  ___set_FP_PGC(vm_t *vm);
static int  ___set_MENU(vm_t *vm, int menu);
static int  ___set_PGCN(vm_t *vm, int pgcN);
static int  ___set_PGN(vm_t *vm); /* Set PGN based on (vm->state).CellN */
static void ___set_RSMinfo(vm_t *vm, int cellN, int blockN);

/* Get */
#define get_PGCN(a) ___get_PGCN(a)
#define get_TT(a,b,c) ___get_TT(a,b,c)
#define get_ID(a,b) ___get_ID(a,b)
#define get_PGCN(a) ___get_PGCN(a)
#define get_MENU_PGCIT(a,b,c) ___get_MENU_PGCIT(a,b,c)
#define get_PGCIT(a) ___get_PGCIT(a)
static int ___get_TT(vm_t *vm, int vtsN, int vts_ttn);
static int ___get_ID(vm_t *vm, int id);
static int ___get_PGCN(vm_t *vm);

static pgcit_t* get_MENU_PGCIT(vm_t *vm, ifo_handle_t *h, uint16_t lang);
static pgcit_t* get_PGCIT(vm_t *vm);

#define dvd_read_name(a,b) ___dvd_read_name(a,b)
#define ifoOpenNewVTSI(a,b,c) ___ifoOpenNewVTSI(a,b,c)

/* Helper functions */

#ifdef TRACE
#define vm_print_current_domain_state(x) ___vm_print_current_domain_state(x)
static void ___vm_print_current_domain_state(vm_t *vm) {
...
static void ___dvd_read_name(char *name, const char *device) {
...
static int ___ifoOpenNewVTSI(vm_t *vm, dvd_reader_t *dvd, int vtsN) {
...
vm_t *___vm_new_copy(vm_t *source) {
...
static pgcit_t* ___get_MENU_PGCIT(vm_t *vm, ifo_handle_t *h, uint16_t lang) {
  int i;
...
static pgcit_t* ___get_PGCIT(vm_t *vm) {
  pgcit_t *pgcit;
