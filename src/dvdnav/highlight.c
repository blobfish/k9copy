...
#include "nav_print.h"
#define print_time(a) ___print_time(a)
static void ___print_time(dvd_time_t *dtime) {
  const char *rate;
...
#define nav_print_PCI_GI(a) ___nav_print_PCI_GI(a)
static void ___nav_print_PCI_GI(pci_gi_t *pci_gi) {
  int32_t i;
...
#define nav_print_NSML_AGLI(a) ___nav_print_NSML_AGLI(a)
static void ___nav_print_NSML_AGLI(nsml_agli_t *nsml_agli) {
  int32_t i, j = 0;
...
#define nav_print_HL_GI(a,b,c) ___nav_print_HL_GI(a,b,c)
static void ___nav_print_HL_GI(hl_gi_t *hl_gi, int32_t *btngr_ns, int32_t *btn_ns) {
...
#define nav_print_BTN_COLIT(a) ___nav_print_BTN_COLIT(a)
static void ___nav_print_BTN_COLIT(btn_colit_t *btn_colit) {
  int32_t i, j;
...
#define nav_print_BTNIT(a,b,c) ___nav_print_BTNIT(a,b,c)
static void ___nav_print_BTNIT(btni_t *btni_table, int32_t btngr_ns, int32_t btn_ns) {
  int32_t i, j, k;
...
#define nav_print_HLI(a) ___nav_print_HLI(a)
static void ___nav_print_HLI(hli_t *hli) {
...
#define nav_print_PCI(a) ___nav_print_PCI(a)
void ___nav_print_PCI(pci_t *pci) {
...
dvdnav_status_t ___dvdnav_get_current_highlight(dvdnav_t *this, int32_t *button) {
...
#define get_current_button(a,b) ___get_current_button(a,b)
static btni_t *___get_current_button(dvdnav_t *this, pci_t *pci) {
  int32_t button = 0;
...
#define button_auto_action(a,b) ___button_auto_action(a,b)
static dvdnav_status_t ___button_auto_action(dvdnav_t *this, pci_t *pci) {
  if (get_current_button(this, pci)->auto_action_mode)
    return dvdnav_button_activate(this, pci);
  return DVDNAV_STATUS_OK;
}

dvdnav_status_t ___dvdnav_upper_button_select(dvdnav_t *this, pci_t *pci) {
  btni_t *button_ptr;
...
dvdnav_status_t ___dvdnav_lower_button_select(dvdnav_t *this, pci_t *pci) {
  btni_t *button_ptr;
...
dvdnav_status_t ___dvdnav_right_button_select(dvdnav_t *this, pci_t *pci) {
  btni_t *button_ptr;
...
dvdnav_status_t ___dvdnav_left_button_select(dvdnav_t *this, pci_t *pci) {
  btni_t *button_ptr;
...
dvdnav_status_t ___dvdnav_button_activate(dvdnav_t *this, pci_t *pci) {
  int32_t button;
...
dvdnav_status_t ___dvdnav_button_activate_cmd(dvdnav_t *this, int32_t button, vm_cmd_t *cmd)
{
  if(!this || !cmd) {
    printerr("Passed a NULL pointer.");
    return DVDNAV_STATUS_ERR;
...
dvdnav_status_t ___dvdnav_button_select(dvdnav_t *this, pci_t *pci, int32_t button) {
...
dvdnav_status_t ___dvdnav_button_select_and_activate(dvdnav_t *this, pci_t *pci,
						  int32_t button) {
  /* A trivial function */
...
dvdnav_status_t ___dvdnav_mouse_select(dvdnav_t *this, pci_t *pci, int32_t x, int32_t y) {
...
dvdnav_status_t ___dvdnav_mouse_activate(dvdnav_t *this, pci_t *pci, int32_t x, int32_t y) {
  /* A trivial function */
