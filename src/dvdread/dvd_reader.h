...
#define DVDVersion() ___DVDVersion()
 ...
 */
dvd_reader_t *___DVDOpen( const char * );
#define DVDOpen(a) ___DVDOpen(a)
/**
 ...
 * DVDClose(dvd);
 */
void ___DVDClose( dvd_reader_t * );
#define DVDClose(a) ___DVDClose(a)
 ...
 */
int ___DVDFileStat(dvd_reader_t *, int, dvd_read_domain_t, dvd_stat_t *);
#define DVDFileStat(a,b,c,d) ___DVDFileStat(a,b,c,d)
/**
...
dvd_file_t *___DVDOpenFile( dvd_reader_t *, int, dvd_read_domain_t );
#define DVDOpenFile(a,b,c) ___DVDOpenFile(a,b,c)
/**
 ...
 */
void ___DVDCloseFile( dvd_file_t * );
#define DVDCloseFile(a) ___DVDCloseFile(a)
/**
 ...
 */
ssize_t ___DVDReadBlocks( dvd_file_t *, int, size_t, unsigned char * );
#define DVDReadBlocks(a,b,c,d) ___DVDReadBlocks(a,b,c,d)
/**
 ...
 */
int ___DVDFileSeek( dvd_file_t *, int );
#define DVDFileSeek(a,b) ___DVDFileSeek(a,b)
/**
 ...
 */
ssize_t ___DVDReadBytes( dvd_file_t *, void *, size_t );
#define DVDReadBytes(a,b,c) ___DVDReadBytes(a,b,c)
 ...
 */
ssize_t ___DVDFileSize( dvd_file_t * );
#define DVDFileSize(a) ___DVDFileSize(a)
 ...
 */
int ___DVDDiscID( dvd_reader_t *, unsigned char * );
#define DVDDiscID(a,b) ___DVDDiscID(a,b)
/**
 ...
 * @return 0 on success, -1 on error.
 */
int ___DVDUDFVolumeInfo( dvd_reader_t *, char *, unsigned int,
                      unsigned char *, unsigned int );
#define DVDUDFVolumeInfo(a,b,c,d,e) ___DVDUDFVolumeInfo(a,b,c,d,e)
/**
 ...
 * @return 0 on success, -1 on error.
 */
int ___DVDISOVolumeInfo( dvd_reader_t *, char *, unsigned int,
                      unsigned char *, unsigned int );
#define DVDISOVolumeInfo(a,b,c,d,e) ___DVDISOVolumeInfo(a,b,c,d,e)
/**
 ...
 */
int ___DVDUDFCacheLevel( dvd_reader_t *, int );
