 ...
 */  
void ___navRead_PCI(pci_t *, unsigned char *);
#define navRead_PCI(a,b) ___navRead_PCI(a,b)
/**
 ...
 */
void ___navRead_DSI(dsi_t *, unsigned char *);
#define navRead_DSI(a,b) ___navRead_DSI(a,b)
#ifdef __cplusplus
};
#endif
